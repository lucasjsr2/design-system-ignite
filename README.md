...
- ⚛️ React 19 + TypeScript 6 components to build your applications using the design system.

## Requirements

- Node `>=22`
- Bun `>=1.3` (the repo uses Bun for installs and scripts; `bun install` then `bun run dev`)
